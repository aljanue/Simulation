...
void setup()
{
  ...
  camera.lookAt(0, 0, 4); // Ajusta la posición de la cámara en el eje Z
  camera.rotateX(0.15); // Rota la cámara en el eje X
  camera.rotateY(0.1); // Rota la cámara en el eje X
